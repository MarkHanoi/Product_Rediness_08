...
function studentsHtml(): string {
    return `
        ...
        ${featureList('For students and graduates', [
            ...
            'Full Architect plan free with verified .edu email — contact pryzmhello@gmail.com',
...
function bespokeHtml(): string {
    return `
        ...
        ${callout('This is scoped and priced separately from all subscription plans. To start a conversation: <a href="mailto:pryzmhello@gmail.com" class="lp-sol-link">pryzmhello@gmail.com</a> with the subject "Bespoke Build Enquiry".')}
    `;
}
