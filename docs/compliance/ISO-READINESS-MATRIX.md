...
5. **This is not a duplicate of [ISSUE-LOG](../04-reference/ISSUE-LOG.md).**
...
- **The L-NN Issue Log** (`docs/04-reference/ISSUE-LOG.md §2`, to **L-781**) — append-only,
...
| 9.2 · Internal audit | A programme: schedule, independence, plan, findings, follow-up | ❌ as a programme. ✅ as *reports* — and they are numerous and high quality: `ISSUE-LOG.md`, `security/{csp,oauth2,plugin-sandbox,rls}-audit-2026-q4.md`, `MISSING-CONTRACTS-AUDIT-2026-06-01.md`, `docs/archive/audits/` | as cited | The reports | — | Unscheduled, point-in-time | Founder | **PROCESS_ONLY (ad-hoc)** | No schedule, no auditor independence, no follow-up loop | Certification blocker | Convert the existing cadence into a scheduled programme. The hard part (capability) is already there |
