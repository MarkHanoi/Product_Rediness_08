...
- **[`reference/adrs/`](./reference/adrs/)** — 45 architectural decision records (ADR-0201 … ADR-0244 + the M28 IFC pipeline). Each is a single decision with rationale. **Cite an ADR; never duplicate one.**
