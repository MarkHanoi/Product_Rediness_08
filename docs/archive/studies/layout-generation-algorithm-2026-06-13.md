# LAYOUT-GENERATION-ALGORITHM.md — ARCHIVED SNAPSHOT (2026-06-13)

> **Status**: SUPERSEDED / ARCHIVED 2026-07-16. This 254-line debugging-session capstone was the
> earlier, smaller of two `LAYOUT-GENERATION-ALGORITHM.md` files. The canonical, maintained version
> is [`04-reference/LAYOUT-GENERATION-ALGORITHM.md`](../../04-reference/LAYOUT-GENERATION-ALGORITHM.md)
> (~3400 lines, source-grounded). Kept here for historical traceability only; do not update.

**Status (original):** living reference · **Author:** Claude (PRYZM agent) · **Date:** 2026-06-13
