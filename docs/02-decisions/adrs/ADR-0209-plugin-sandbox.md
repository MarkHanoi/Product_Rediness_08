# ADR-0209 — Plugin Sandbox Model

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0209; `CRITICAL-REVIEW-2026-04-27.md` line 175 |
...
- S72 (M36 GA) — public SDK 1.0; marketplace open per ADR-0218 cut-list outcome.
