# ADR-0205 — PrimitiveCommitter interface
...
| Supersedes | — |
| Related | `phases/PHASE-1A-Q1-M1-M3-SKELETON-RAILS.md §S04 Track B` (lines 442-469); ADR-0201 (typed-id brand); ADR-0202 (PatchEmitter envelope); ADR-0203 (frame-scheduler) |
...
> T6 — `PrimitiveCommitter<TDto, TElement>` interface (ADR-0205).
...
- ADR-0201 (ElementId brand strategy), ADR-0202 (PatchEmitter envelope), ADR-0203 (frame-scheduler).
