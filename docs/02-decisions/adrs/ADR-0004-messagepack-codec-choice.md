# ADR-0204 — MessagePack codec choice for the persistence wire format
...
| Supersedes | — |
| Related | `phases/PHASE-1A-Q1-M1-M3-SKELETON-RAILS.md §S03-T8` (line 376), `§S03 exit criteria` (line 414), `§S04 Track A` (line 419); ADR-0202 (PatchEmitter envelope shape) |
...
> speed, bundle size of the codec. Output to ADR-0204 draft. **Target:
...
is the L0/L2 contract for codec evolution. ADR-0204 sets it to `1`
...
- ADR-0202 (PatchEmitter envelope shape, ULID + audit metadata).
