...
| Threshold (ADR-0229 Part E) | Required | Measured at S72 D5 |
|---|---|---|
...
`preview` or full label per ADR-0229 Part E").
...
3. IFC 4.3 advanced features per `[strategic ADR-0208]` — P2.
...
`[strategic ADR-0218]` Tier-1 + Tier-2 cut-list final state at GA:
...
| Strategic ADR | `[strategic ADR-0218]` Tier-1 + Tier-2 cut-list                                            | Cut-list final state in Decision F                                                              |
| Strategic ADR | `[strategic ADR-0221]` SOC2 sequencing                                                     | Quality §3 SOC2 deferral to post-GA                                                             |
| Strategic ADR | `[strategic ADR-0226]` zero `react` symbols in editor bundle                              | Architectural §3 reading; gate in `apps/editor/package.json` deps                              |
| Strategic ADR | `[strategic ADR-0229]` PDF-to-BIM accuracy thresholds                                     | Decision C + ADR-0052 §E                                                                        |
