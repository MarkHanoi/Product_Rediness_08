# ADR-0203 — Object Storage Backend

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0203 |
...
- **Self-host (D7 enterprise variant):** MinIO bundled in the docker-compose stack (see ADR-0212). The same `S3` API surface is used; switching is a config change only.
