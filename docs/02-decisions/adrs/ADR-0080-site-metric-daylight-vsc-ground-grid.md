...
| Extends | [ADR-0079](./ADR-0079-site-metric-analysis-disc-decoupled-from-camera.md) (analysis-disc + §SITE-METRIC-HEATMAP family), [ADR-0074](./ADR-0074-gpu-solar-sun-hours-environmental-analysis.md) (solar/env analysis) |
...
would violate the L7 boundary (ADR-0202 §2). Consistent with the existing exported
