...
### Part F — capacity-cut alignment (per ADR-0218)
...
These cuts mirror ADR-0218's discipline.
...
- S49 (Phase 3A start) — ADR-0229 land; SPEC-31 outline drafted; fixture corpus collection begins.
