# ADR-0204 — Wire Format

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0204 |
...
The PRYZM event stream (per ADR-0202) is the canonical persistence + audit + undo + public-API + `.pryzm`-file format. It needs:
...
The Yjs update stream is a separate byte stream (per ADR-0202) and is **not** governed by this ADR.
