# ADR-0223 — Library rAF Quarantine
...
| Spec dependency | SPEC-12 §5 (lazy chunk policy); ADR-0222 Part F |
...
### Part E — telemetry (per `[strategic ADR-0207]`)
...
- S31 — ADR-0223 land (Phase 2B start); allow-list shipped; telemetry added (warning level on misses); Cesium mount lazy + disposable.
