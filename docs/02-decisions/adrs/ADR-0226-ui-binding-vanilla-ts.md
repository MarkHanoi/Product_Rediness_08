# ADR-0226 — UI Binding: Vanilla TS (Path A confirmed); React in deps but unused at runtime
...
- S31 — ADR-0226 land (Phase 2B start; Phase 2A holds no gap-closure); `pryzm/no-react-runtime` ESLint rule warning; bundle gate per SPEC-12 §7.1.
