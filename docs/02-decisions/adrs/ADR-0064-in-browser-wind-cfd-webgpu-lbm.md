...
**Related ADRs**: [ADR-0007](./ADR-0007-webgpu-webgl2-dual-mode.md) (WebGPU/WebGL2 dual mode — the rendering substrate), [ADR-0061](./ADR-0061-building-graph-bidirectional-edit-substrate.md) (determinism — a CFD result must be reproducible to feed the engine)
