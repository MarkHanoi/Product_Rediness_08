# ADR-0254 — Reference-only repos as gitignored subtrees
...
- **ADR-0252** — Docs-site marketing surface (the deploy that surfaced this).
- **ADR-0253** — Lockfile-drift policy (same build-infrastructure CI gate batch).
