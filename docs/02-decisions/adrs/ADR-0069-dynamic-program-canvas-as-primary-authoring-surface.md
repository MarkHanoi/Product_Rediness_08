...
**Related ADRs:** [ADR-0061](./ADR-0061-building-graph-bidirectional-edit-substrate.md) (graph is a bidirectional edit substrate — the determinism doctrine this generalises), [ADR-0058](./ADR-0058-unified-building-graph.md) (specialised graphs are projections of one model), [ADR-0060](./ADR-0060-living-design-parameters.md) (sliders bind to the existing substrate, not a parallel scorer), [ADR-0067](./ADR-0067-graph-ir-intent-first-building-graph-bim3.md) (graph-IR / intent-first BIM 3.0 — geometry is a DERIVED projection, never user-authored), [ADR-0056](./ADR-0056-typology-declared-brief.md) (typology-declared brief — the brief schema the canvas absorbs).
