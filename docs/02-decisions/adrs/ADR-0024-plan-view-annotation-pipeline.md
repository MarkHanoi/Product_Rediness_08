...
**Authority**: Subordinate to **`[strategic ADR-0216]`** (drawing engine architecture) and **code-level ADR-0023** (Plan-View Canvas2D Renderer).
...
- Strategic: `[strategic ADR-0216]` — drawing engine architecture
