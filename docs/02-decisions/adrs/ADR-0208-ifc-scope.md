# ADR-0208 — IFC Scope for v1

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0208 |
...
`05-IMPLEMENTATION-PLAN.md §17` proposed "Existing PRYZM corpus." `10-MASTER-IMPLEMENTATION-PLAN-36M.md` row ADR-0208 sharpened to "Read+write Pset round-trip; defer IFC4.3 advanced for post-GA." This ADR ratifies the sharpened position.
