...
typed-id brand contract (ADR-0201). Parity capture normalises both to
...
emit channel instead (DOM-free per ADR-0202 §3).
...
* `docs/02-decisions/adrs/ADR-0002-command-handler-signature.md` — the
