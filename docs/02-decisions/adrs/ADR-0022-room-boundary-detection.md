...
|---|---|---|
| `0020-room-boundary-detection.md` | **`ADR-0022-room-boundary-detection.md`** | S25 (this ADR) |
...
unaffected — `[strategic ADR-0220]`, `[strategic ADR-0221]`, and
`[strategic ADR-0222]` continue to mean Property-test suite, Enterprise
...
* `[strategic ADR-0224]` — Constraint solver phase gating (no solver in 2A)
* `code-level ADR docs/02-decisions/adrs/ADR-0009-producer-pure-function-signature.md`
