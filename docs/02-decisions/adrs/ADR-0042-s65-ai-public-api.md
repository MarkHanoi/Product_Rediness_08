...
* **Related**: ADR-0041 (api-gateway), ADR-0237 (AI host lazy bootstrap), SPEC-28 §9, K3-D gate
...
| Per-workflow rate-limit overrides | S67 | ADR-0218 default buckets satisfy initial demand |
