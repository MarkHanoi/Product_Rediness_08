# ADR-0212 — Self-Host Minimum Requirements

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0212 |
...
- Optional: `HONEYCOMB_API_KEY` (off by default, per ADR-0207).
