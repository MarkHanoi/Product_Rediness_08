...
**Reference audits**: ARCHISTAR-EUROPE-COMPETITIVE-GAP-AUDIT-2026-07-17.md (audit removed 2026-08-09 — recoverable from git history) (the gap audit that scoped this, L-398..404), [PARCEL-ZONING-FEATURE-SCOPING.md](../../04-reference/geospatial/PARCEL-ZONING-FEATURE-SCOPING.md) (L-380 scoping), [DENMARK-GEOSPATIAL-REFERENCE-ARCHITECTURE.md](../../04-reference/DENMARK-GEOSPATIAL-REFERENCE-ARCHITECTURE.md) (L-383 Denmark reference).
