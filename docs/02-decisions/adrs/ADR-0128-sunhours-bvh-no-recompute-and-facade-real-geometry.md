> **Renumbered 2026-07-16**: originally filed as `ADR-0110`, which collided with [ADR-0110 — Unified furniture plan-symbol vocabulary](./ADR-0110-unified-furniture-plan-symbol-vocabulary.md). Renumbered to **ADR-0128** to resolve the duplicate. Body below is unchanged from the original. See the old→new map in [adrs/README.md §2.1](./README.md).

# ADR-0128 (formerly ADR-0110) — Forma sun-hours: BVH-accelerated raycast, no-recompute caching, and the path to real-geometry façade analysis
