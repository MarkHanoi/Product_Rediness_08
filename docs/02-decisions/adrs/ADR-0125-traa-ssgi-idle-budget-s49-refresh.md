> **Renumbered 2026-07-16**: originally filed as `0014` (a sprint-scoped refresh of [ADR-0014](./ADR-0014-traa-ssgi-idle-budget.md)), which collided with the base ADR-0014. Renumbered to **ADR-0125** to resolve the duplicate. Body below is unchanged from the original. See the old→new map in [adrs/README.md §2.1](./README.md).

# ADR-0125 (formerly 0014-refresh) — TRAA + SSGI Idle Budget for the AI Plane

| Field | Value |
|---|---|
| Status | **Accepted (sprint-scoped refresh)** — 2026-04-28 |
| Sprint | S49 (Phase 3A) |
| Refreshes | `docs/02-decisions/adrs/ADR-0014-traa-ssgi-idle-budget.md` (original 2025-12) |
| Cross-refs | `[strategic ADR-0214]` (AI L7.5 operational); `[strategic ADR-0218]` (capacity-cut Tier-1 checkpoint) |
...
- A single dashboard panel can split AI cost (`pryzm.ai.cost.usd`)
  ...
  cross-talk.
- The capacity-cut Tier-1 checkpoint (`[strategic ADR-0218]` T1.7)
...
- `docs/02-decisions/adrs/ADR-0214-ai-l75-operational.md`
- `docs/02-decisions/adrs/ADR-0218-capacity-cut-list.md` Tier-1 checkpoint
