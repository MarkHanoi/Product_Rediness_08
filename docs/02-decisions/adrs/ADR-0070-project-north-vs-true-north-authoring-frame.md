...
- **Related:** [C12-GEOSPATIAL](../contracts/C12-GEOSPATIAL.md) · [C19-SITE-MODEL-AND-PARCEL](../contracts/C19-SITE-MODEL-AND-PARCEL.md) · [ADR-0055 Pascal wall pipeline] · [ADR-0063 house generative doctrine](ADR-0063-house-generative-layout-doctrine.md) · supersedes the weld-tolerance band-aid proposed in the 2026-06-11 root-cause analysis
