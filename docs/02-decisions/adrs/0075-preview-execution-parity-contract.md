...
**Related ADRs**: [0069](./0069-graph-authoritative-room-identity-at-execution.md) (graph-authoritative ROOM identity — the room slice of this contract, already shipped), [0073](./ADR-0073-house-execution-frame-parity-with-apartment.md) (house↔apartment frame parity), [0070](./0070-project-north-vs-true-north-authoring-frame.md) (the weld frame), [0061](./0061-building-graph-bidirectional-edit-substrate.md) (determinism / projection)
