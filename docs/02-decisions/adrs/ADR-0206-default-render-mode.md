# ADR-0206 — Default Render Mode

| Field | Value |
|---|---|
| Status | **Accepted** — 2026-04-27 |
| Closes | `05-IMPLEMENTATION-PLAN.md §17` row ADR-0206 |
...
`05-IMPLEMENTATION-PLAN.md §17` proposed "WebGL2 default for v1, WebGPU opt-in; flip in v2." `10-MASTER-IMPLEMENTATION-PLAN-36M.md` row ADR-0206 amended this to "WebGPU when available, WebGL2 fallback. Visual diff CI gate enforces parity." This ADR ratifies the **amended** position.
...
| Plan-view direct draw | n/a | n/a | Plan view is Canvas2D (per ADR-0216), not WebGL/WebGPU. |
