...
- Supersedes / relates to: ADR-060 (§LOAD-CHUNKED — chunked element BUILD + diag-flood gating),
...
§LOAD-CHUNKED (ADR-060) chunks the element BUILD across frames, but NOT the post-load
