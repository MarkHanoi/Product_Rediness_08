# ADR-0207 — WebGPU / WebGL2 dual-mode renderer strategy
...
- ADR-0208 will revisit when WebGPU becomes the unconditional default (target: Chrome ≥120 ships fully).
- ADR-0209 will document the post-FX pipeline once we re-introduce PASCAL (planned for 1B/M5).
