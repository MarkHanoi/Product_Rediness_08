...
**Related:** [ADR-0056](./ADR-0056-typology-declared-brief.md) (typology-declared brief — the onboarding sibling).

> **Numbering note:** `0059` is already taken (`ADR-0059-monorepo-typecheck-profile-and-emit.md`) and
> `0057` exists as `ADR-0257-realtime-geometry-and-view-interactivity.md`, so this ADR is **0060**.
