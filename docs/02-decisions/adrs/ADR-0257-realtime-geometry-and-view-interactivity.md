# ADR-0257 — Realtime geometry editing & view interactivity
...
- **References:** [ADR-0055](./ADR-0055-wall-junction-pascal-style.md) (Pascal per-wall miter,
  ...
  [ADR-0251](./ADR-0251-undo-single-source-of-truth.md) (single undo path),
...
regression to join correctness (ADR-0055) or undo (ADR-0251).
...
- No change to the undo model (still one `door.setOffset` per drag, ADR-0251 single path).
