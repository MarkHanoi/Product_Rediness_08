...
| **A.26.5** inverse — model edit → graph live | (planned) | The §3.3 rebuild already re-projects engine-driven changes; A.26.5 adds the DIRECT model-edit (drag a wall) → graph reflection. |
