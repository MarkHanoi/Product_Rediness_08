...
| **L-11006** | **FacadeIR → BIM elements** (brief §24) is NOT built. Milestone 2. When it lands it is bound by **C11**, **C16**, **C84** and the `C85`–`C99` block, and this row is where that starts. | OPEN |
