...
> **Evidence appendices** (READ-ONLY, cited never restated): ⚠ **all four Phase-0 inventories were deleted in the 2026-08-15 corpus collapse and were NOT carried forward — they are citable from git history only**, and nothing normative in this contract depends on re-reading them: `BIM30-PHASE0-ELEMENT-INVENTORY.md` (0A — elements, stores, verbs) · `BIM30-PHASE0-RELATIONSHIP-INVENTORY.md` (0B — the 35 relationships) · `BIM30-PHASE0-CONSEQUENCE-MACHINERY.md` (0C — the machinery and the couplings) · `BIM30-PHASE0-CROSSCUTTING-INVENTORY.md` (0D — constraints, provenance, undo, concurrency, persistence; gaps G-1…G-16). For the live measured state read [`BIM30-MASTER-COMPLETION-TRACKER.md`](../../03-execution/plans/BIM30-MASTER-COMPLETION-TRACKER.md); for the surviving protections and gate rules read [`BIM30-IMPLEMENTATION-ROADMAP.md`](../../03-execution/plans/BIM30-IMPLEMENTATION-ROADMAP.md) §6–§7.
