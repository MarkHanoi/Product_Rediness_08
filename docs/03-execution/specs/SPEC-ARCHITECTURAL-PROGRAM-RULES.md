...
- **Related:** [SPEC-LAYOUT-CONSTRAINT-DATABASE](./SPEC-LAYOUT-CONSTRAINT-DATABASE.md) (248 normative constraints — UK Building Regs / London Plan / HQI / BS / BRE / CIBSE / NKBA / IEE / ISO 16739; this SPEC is the connectivity + program subset that drives the engine today), [SPEC-TGL-DETERMINISTIC-LAYOUT-ENGINE](./SPEC-TGL-DETERMINISTIC-LAYOUT-ENGINE.md), [SPEC-FURNITURE-LAYOUT-ENGINE](./SPEC-FURNITURE-LAYOUT-ENGINE.md), [C09](../../../02-decisions/contracts/C09-AI-AND-VISIBILITY-INTENT.md), [C15](../../../02-decisions/contracts/C15-HOSTED-ELEMENTS.md).
