...
| **ADR-0002** (`0002-command-handler-signature.md`) | `HandlerContext.stores` / `affectedStores` — the store-key contract behind `a4a1af27` |
| **ADR-0028** (`0028-plan-view-canvas-architecture.md`) | the plan-view canvas / `PlanViewAnnotationRenderer` that draws annotations |
