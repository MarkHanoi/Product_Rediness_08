...
**Theme**: **Typology pipeline foundations** + **marketplace go-live** + **apex/app split** (ADR-0255/C51). Q3 sets up the infrastructure for Q4's deliverables.
...
| **E7 — Apex/app split (ADR-0255/C51), tracked under IP-A5.X** | Engineer 3 (extend) | — | Designer 2 + Marketing | S1–S5 |
...
| 1.8 | `pryzm.so` apex (Cloudflare Pages) + `app.pryzm.so` (Fly `fra`) DNS + TLS provisioned per ADR-0255/C51 §4 | ops + Marketing | E7 | [Phase 1 §8.1](./roadmap-phase-1-alpha.md) |
...
**S5 acceptance**: C19 + C21 ratified CANONICAL; apex/app split live (ADR-0255/C51); brand voice consistent; DSAR endpoints live.
...
*End — PRYZM Quarterly Plan 2026 Q3, 2026-06-03 (reconciled to ADR-0255/C51) — CANONICAL.*
