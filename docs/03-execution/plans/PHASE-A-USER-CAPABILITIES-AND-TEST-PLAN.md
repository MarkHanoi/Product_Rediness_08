...
| 7.4 | WCAG 2.2 AA contrast on every surface | All UI | A.32 (axe-core CI) + A.34 (contrast sweep) | ⚪ PLANNED | `pnpm test:axe` → 0 critical · 0 serious violations |
...
| 12.3 | Daylight rule-checker | Validation panel | A.38 | ⚪ PLANNED | "Bedroom 1 has no exterior window — daylight rule failed" |
