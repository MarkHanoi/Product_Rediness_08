...
|---|---|---|---|
| 01 | `01-objective-and-audit.md` (audit removed 2026-08-09 — recoverable from git history) | §0 + §1 + §2 | v1 retraction; operator intent; cast-site count (769 in `src/ui/`); two-hub two-editor split |
