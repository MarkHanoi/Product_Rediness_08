...
| **A.7.b** | **SiteStore (L3 reactive store)** | `packages/stores/src/site/SiteModelStore.ts` per [C19 §3.1](../../02-decisions/contracts/C19-SITE-MODEL-AND-PARCEL.md). Subscribable; resolution helpers. | ⚪ PLANNED (Sprint 2) |
| **A.7.c** | **`site.*` commands per C16** | site.create · site.setParcelBoundary · site.updateLocation · site.updateZoning · site.addContextBuilding · etc. Refs: [C19 §4](../../02-decisions/contracts/C19-SITE-MODEL-AND-PARCEL.md). | ⚪ PLANNED (Sprint 2) |
