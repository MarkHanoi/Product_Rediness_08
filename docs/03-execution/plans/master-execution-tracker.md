...
| **A.18** | **Pricing page from entitlement registry** | Multi-slice; broken into A.18.a (L2 `@pryzm/entitlements` package — registry + resolver + pricingPage generator — DONE) and A.18.b (L5 React `apps/docs-site/src/pricing.tsx` consuming `buildPricingPageData()` — PLANNED). Refs: [C39 §1.1 + §1.2 + §1.13](../../02-decisions/contracts/C39-PRICING-AND-PLAN-TIERS.md). | 🟢 IN PROGRESS (Sprint 2) |
