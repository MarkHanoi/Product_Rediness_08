...
| **A.23.b.2** | **L3 ApartmentStore + RoomStore + nullable-apartmentId widening** | The 2 leaf stores. Includes the `RoomParameters.apartmentId` nullable-widening to close the [C20 §2.4](../../02-decisions/contracts/C20-BUILDING-AND-APARTMENT-AGGREGATES.md) public-corridor gap atomically with the L3 RoomStore wiring. | ⚪ PLANNED (Sprint 1–2) |
| **A.23.c** | **building.* / level.* / apartment.* / room.* commands** | Per C20 §4. CRUD + level-activate + apartment-rename + room-reassign. | ⚪ PLANNED (Sprint 7–9) |
| **A.23.d** | **composeRuntime wiring** | runtime.buildingStore + runtime.levelStore + runtime.apartmentStore + runtime.roomStore. | ⚪ PLANNED (Sprint 8) |
