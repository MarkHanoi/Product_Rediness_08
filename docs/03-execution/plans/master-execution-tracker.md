...
| **A.34** | **Color-contrast token sweep** | Multi-slice; broken into A.34.a (L2 `@pryzm/a11y-tokens` package — registry + audit — DONE) and A.34.b (focus-ring + form-control border tokens — PLANNED). Refs: [C43 §1.5](../../02-decisions/contracts/C43-ACCESSIBILITY.md). | 🟢 IN PROGRESS (Sprint 2) |
