...
|---|---|---|---|---|---|---|---|
| **✅ 1 — REACHED 2026-06-02** | **IP-A5** | Sprint 5 · 2026-09-08 | **Brand cutover + C19/C21 canonical** | "I navigate to pryzm.so, see the new landing + pricing + manifesto + trust pages, and AI-generated apartment layouts show provenance details in the inspect panel." | ✅ A.17 (Cloudflare Pages live; pryzm.so apex CNAME → pages.dev; TLS issued), ✅ A.M.3 (manifesto.astro — iter 5.4a DONE), ✅ A.M.4 (trust.astro — iter 5.4b DONE), ✅ A.18 (pricing-page generator — L2 + L5 Astro page DONE; JSON-snapshot pattern per ADR-052 §1.4), ✅ A.M.5 (root index.astro marketing landing DONE — enriched with 79/47/18/21 stats + capabilities + interop matrix + 8 invariants), ✅ A.31.e (L5 Provenance panel + right-click menu — iter 5.2/5.2.b/5.2.c DONE, 48 tests), ⚪ C19 + C21 ratifications (deferred — not gating the user-facing IP) | (1) pryzm.so redirect + landing pages work ✅ live at https://pryzm.so/; (2) Pricing page reads from entitlement registry ✅; (3) Right-click → "Show AI provenance" ✅ engineering DONE | ✅ ALL user-facing acceptance criteria met 2026-06-02. Followup tasks (richer marketing media · contract ratifications) tracked separately. |
