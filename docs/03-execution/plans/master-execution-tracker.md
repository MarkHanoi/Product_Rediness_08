...
|---|---|---|---|---|---|---|---|
| **🎯 1 — DRIVING NOW** | **IP-A5** | Sprint 5 · 2026-09-08 | **Brand cutover + C19/C21 canonical** | "I navigate to pryzm.so, see the new landing + pricing + manifesto + trust pages, and AI-generated apartment layouts show provenance details in the inspect panel." | 🟡 A.17 (DNS — user setting up Cloudflare Pages for pryzm.so), ✅ A.M.3 (manifesto.astro — iter 5.4a DONE), ✅ A.M.4 (trust.astro — iter 5.4b DONE), ✅ A.18 (pricing-page generator — L2 + L5 Astro page DONE), ✅ A.31.e (L5 Provenance panel + right-click menu — iter 5.2/5.2.b/5.2.c DONE, 48 tests), ⚪ C19 + C21 ratifications | (1) pryzm.so redirect + landing pages work — 🟡 user driving Cloudflare deploy; (2) Pricing page reads from entitlement registry ✅; (3) Right-click → "Show AI provenance" ✅ engineering DONE | 🟢 ~ 90 % engineering DONE; gated only on user's Cloudflare deploy going green |
