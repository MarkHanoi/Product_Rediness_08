...
> **Stamp**: 2026-05-03 · **Status**: CANONICAL · **Last amended**: 2026-05-19 (Comprehensive Audit Rev 4)
...
Eight production-breaking defects in the element creation pipeline were identified and fixed on 2026-05-19. They are documented here permanently so they cannot recur silently.
...
| **Stair** | ❌ No CEB case (comment: "no initTools subscriber") | ❌ No bridge | ✅ `StairStore.add()` → storeEventBus (line 171) | ✅ `'stair'` | ❌ (no bridge — N/A) | ❌ | ⚠️ LEGACY-ONLY — stair element is created via `commandManager` (legacy path), not bus |
