...
**Source**: `phases/PHASE-3D-Q4-M34-M36-HARDENING-GA.md` §7 (Post-GA Roadmap Seeds) + `docs/post-mortems/PRYZM-2-build.md` §5 (operator-side carry-forward register)
...
| 4 | PRYZM 1 → PRYZM 2 batch migration tool | 90-day sunset window already counting from S61; per-project tool is in CLI; batch tool needs a 1-2 sprint dedicated push | phase-doc §7 + `docs/operations/pryzm-1-sunset.md` |
| 5 | First quarterly secret-rotation drill | SOC2 §1.10 contract; first drill scheduled S68 D10 (carry-forward) | `docs/security/secret-rotation-playbook.md` §5 |
...
| 8 | Status page + alerting live provisioning | §3 Business "monitoring + alerting verified" | `docs/operations/status-page-and-on-call.md` |
...
| 20 | All 72 sprint retros archived in `docs/retros/` | post-S72 D10 mechanical |
...
| 28 | `src/` PRYZM 1 tree deletion (post 90-day sunset window) | `docs/operations/pryzm-1-sunset.md` §3; mechanical once sunset closes |
...
- `docs/post-mortems/PRYZM-2-build.md` §5 (carry-forward register, 26 items deduplicated)
- `apps/bench/reports/M36-GA.md` §5 (operator-side carry-forward register)
- `docs/architecture/adr/0054-s72-m36-ga-launch-gate.md` §G (consolidated)
- `docs/operations/pryzm-1-sunset.md` (sunset schedule)
- `docs/operations/cut-list-log.md` (Tier-1 + Tier-2 final state)
- `docs/operations/status-page-and-on-call.md` (S72 D3 runbook)
