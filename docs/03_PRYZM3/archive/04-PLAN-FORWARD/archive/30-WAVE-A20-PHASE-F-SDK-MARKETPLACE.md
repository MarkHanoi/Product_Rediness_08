...
> **Anchored to**: `../01-VISION.md §4` (D4 — SDK + marketplace, D7 — PWA/field-ready), `../01-VISION.md §8` (rule 4 — Phase F gate), `../02-ARCHITECTURE.md §8` (booleans #7 #8 #9), `../../00_Contracts/C07-PLUGIN-SDK-AND-MARKETPLACE.md §1–§5`, `../../00_Contracts/C08-COLLABORATION-AND-SECURITY.md §6`
