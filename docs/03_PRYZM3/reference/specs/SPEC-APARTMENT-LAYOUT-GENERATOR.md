...
| **A5-modal** ⏳ | modal UI (§11) — cards, FrameScheduler thumbnail, score breakdown; the trigger (command/panel) that calls `ensureApartmentLayoutRegistered` then `plane.submit` | renders N options |
