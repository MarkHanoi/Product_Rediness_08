...
| **api-gateway** | REST + WS surface (PORT 5101). S65 / ADR-0241 + ADR-0242. |
...
| **ai-host** | AI host (L7.5); lazy-loaded surface; 7 workflows under `src/workflows/`. Zero first-paint bytes per ADR-0214. |
...
Per [operating-principles O5](./STR-06-operating-principles.md), gaps are filled by **editing this doc**, not by writing a `*-AUDIT-YYYY-MM-DD.md` alongside it.

---

## §13 — What this document is NOT

- Not the layered architecture rules → [STR-04-architecture.md](./STR-04-architecture.md)
