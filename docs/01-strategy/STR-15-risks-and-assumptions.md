...
3. We update those docs explicitly (per the [operating principles O5](./STR-06-operating-principles.md) discipline of editing canonical docs, not writing audit-replacements)
...
**Mitigation**: (a) C25 + C26 + C30 contracts codify the IFC + RVT + sheet quality bar. (b) D11 sheet quality + D12 Revit round-trip are explicit differentiators in [engineering-vision §4](./STR-03-engineering-vision.md). (c) We can extend the editor to be the documentation phase too — the architecture supports it; the year-2 roadmap includes it.
...
**Mitigation**: developer relations programme + transparent economics ([C40](../02-decisions/contracts/C40-MARKETPLACE-ECONOMICS.md)) + first-party plugins (47 of them) that seed the marketplace. The flywheel risk has named monitoring metrics in [platform-strategy §11](./STR-10-platform-strategy.md).
...
**The claim**: The 248-rule constraint database + the cognition substrate ([STR-12-site-and-cognition-strategy.md](./STR-12-site-and-cognition-strategy.md)) is hard to clone + grows in value with each rule added. The substrate is a durable moat.
...
**Mitigation**: we open-source the rules (per the brand's openness-over-secrecy moat in [positioning §4.1](./STR-07-positioning.md)) and stop trying to defend them as a secret. The defensibility is the *platform that operationalises the rules*, not the rules themselves.
...
**Mitigation**: the [operating-principles O8](./STR-06-operating-principles.md) — hire bar over team size. Saying no to candidates. Slower headcount growth than industry typical.
...
**Mitigation**: the [operating-principles §8 remote + no-meeting-Wednesday + cadence discipline](./STR-06-operating-principles.md). The "ship to the bar, not the deadline" principle ([O1](./STR-06-operating-principles.md)) is partly a burnout-prevention principle.
...
**The risk**: as we grow, the brand voice ([manifesto §5](./STR-01-manifesto.md)) softens into generic SaaS marketing. The architect-specificity erodes. We lose the asymmetric brand moat.

**Likelihood**: high (this is the default trajectory of scaling startups).

**Impact**: significant.

**Mitigation**: the quarterly brand-voice audit + the [operating-principles O7](./STR-06-operating-principles.md). The founder + the content lead jointly hold the line on every customer-facing surface.
...
**Mitigation**: the "human in the loop" framing ([product-vision §3](./STR-02-product-vision.md) + [manifesto §6](./STR-01-manifesto.md)) is genuine. We do not promise AI-replaces-architect; we promise AI-extends-architect. We invest in the architect-on-the-team standard ([operating-principles O2](./STR-06-operating-principles.md)) so the framing is credible.
...
**Mitigation**: the pricing-tier breadth ([go-to-market §5](./STR-08-go-to-market.md)) — Solo + Studio survives at low ACV; Enterprise customers who weather the storm provide recurring revenue. Net revenue retention models survive better than CAC-led models.
...
**Mitigation**: monthly unit-economics review per [operating-principles §6.3](./STR-06-operating-principles.md). Per-tier gross-margin targets in [go-to-market §5.3](./STR-08-go-to-market.md). If unit economics regress, the response is product-side (cheaper AI routing, response-cache hit-rate improvements, BYOK adoption push) before pricing-side (which is the last resort).
...
Risks at "high impact" + "high likelihood" graduate to weekly review regardless of category. Risks that materialise (incident, market change, customer loss) trigger an [operating-principles §9 post-mortem](./STR-06-operating-principles.md).
...
| Doc | Relationship |
|---|---|
| [STR-01-manifesto.md](./STR-01-manifesto.md) | The thesis whose bets these risks shadow |
| [STR-07-positioning.md](./STR-07-positioning.md) | The competitive risks (§3) reference this |
| [STR-09-personas.md](./STR-09-personas.md) | Customer-concentration risk (§5.5) traces to these |
| [STR-08-go-to-market.md](./STR-08-go-to-market.md) | Macro / unit-economics risks (§8) |
| [STR-10-platform-strategy.md](./STR-10-platform-strategy.md) | Platform-thesis risk (§2.5) |
| [STR-12-site-and-cognition-strategy.md](./STR-12-site-and-cognition-strategy.md) | Substrate-moat risk (§2.6) |
| [STR-06-operating-principles.md](./STR-06-operating-principles.md) | Cultural + hiring + burnout risks (§5, §7) |
