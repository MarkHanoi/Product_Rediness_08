...
> **Foundation above**: [STR-01-manifesto.md](./STR-01-manifesto.md) (founding intent + brand voice) → [STR-02-product-vision.md](./STR-02-product-vision.md) (what + how + roadmap)
> **Cross-cut**: [STR-09-personas.md](./STR-09-personas.md) (who we serve) · [STR-08-go-to-market.md](./STR-08-go-to-market.md) (how we sell)
...
These are the bets that distinguish PRYZM from every named competitor. Each is also codified as a "D-number" in [STR-03-engineering-vision.md §4](./STR-03-engineering-vision.md). The strategic thesis behind each:
...
| **D10** | **Honest performance contracts** | 17 NFTs measured in CI every commit. The customer who buys PRYZM gets the cold-boot, frame budget, and bundle-size targets we publish, not the "best-case marketing demo" numbers. Codified in [STR-03-engineering-vision.md §5](./STR-03-engineering-vision.md). |
...
Compressed positioning per customer archetype (see [STR-09-personas.md](./STR-09-personas.md) for full personas):
...
| Doc | Relationship |
|---|---|
| [STR-01-manifesto.md](./STR-01-manifesto.md) | The founding intent + brand voice this positioning expresses |
| [STR-02-product-vision.md](./STR-02-product-vision.md) | The product capabilities this positioning describes |
| [STR-03-engineering-vision.md](./STR-03-engineering-vision.md) | The D1–D13 differentiators codified |
| [STR-09-personas.md](./STR-09-personas.md) | The customer archetypes (C1–C5) per-segment positioning addresses |
| [STR-08-go-to-market.md](./STR-08-go-to-market.md) | How we operationalise the positioning into channels + pricing |
| [STR-10-platform-strategy.md](./STR-10-platform-strategy.md) | The two-sided platform thesis |
| [STR-15-risks-and-assumptions.md](./STR-15-risks-and-assumptions.md) | What could falsify the positioning thesis |
