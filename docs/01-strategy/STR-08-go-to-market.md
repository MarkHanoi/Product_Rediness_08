...
| **Existing-customer referrals** | The "Sofia tells other solo architects" loop in [STR-09-personas.md §2.6](./STR-09-personas.md) | Compounding (built-in feature: $50 credit per referred trial that converts) |
...
The first emergency for any growth-marketing pressure to add chaff is: re-read the [manifesto §5 brand voice](./STR-01-manifesto.md). The chaff is removed.
...
| Doc | Relationship |
|---|---|
| [STR-01-manifesto.md](./STR-01-manifesto.md) | Brand voice that the GTM honours |
| [STR-07-positioning.md](./STR-07-positioning.md) | Competitive case the GTM operationalises |
| [STR-09-personas.md](./STR-09-personas.md) | The customer archetypes the GTM targets |
| [STR-10-platform-strategy.md](./STR-10-platform-strategy.md) | Marketplace + developer GTM (C5) |
| [STR-15-risks-and-assumptions.md](./STR-15-risks-and-assumptions.md) | GTM-specific risks |
