...
> **Authority**: this doc owns **how PRYZM the company works** — culture, hiring bar, decision-making, review cadence, what we celebrate, what we refuse to do. Distinct from [STR-03-engineering-vision.md §2 P1–P8 architectural principles](./STR-03-engineering-vision.md), which govern the *code*. This doc governs the *team and the practice*.
> **Foundation above**: [STR-01-manifesto.md](./STR-01-manifesto.md) → [STR-07-positioning.md](./STR-07-positioning.md)
> **Cross-cut**: [STR-08-go-to-market.md](./STR-08-go-to-market.md) (the GTM expression of these principles) · [STR-15-risks-and-assumptions.md](./STR-15-risks-and-assumptions.md)
...
Every shipped feature has a metric. The metric is published in CI per the NFT framework ([engineering-vision §5](./STR-03-engineering-vision.md)) — `cold-boot`, `tool-latency`, `frame-budget`, etc. — or in the team's monthly OKR readout. Features without metrics aren't shipped.
...
Every customer-facing surface (UI copy, marketing site, support email, error message, sales deck) passes through the brand-voice filter ([manifesto §5](./STR-01-manifesto.md)). The discipline is enforced via PR review + content audit. The brand voice is not negotiable for the sake of short-term conversion lift.
...
**Why**: brand voice is the asymmetric moat (per [positioning §4.3](./STR-07-positioning.md)). It compounds when consistent + collapses when inconsistent.
...
The customer's time is the product. A 30-second cold boot, a flaky multiplayer connection, a confusing error message — these are not small annoyances; they are direct customer-time-cost. The whole NFT framework ([engineering-vision §5](./STR-03-engineering-vision.md)) operationalises this. The brand voice ([manifesto §5](./STR-01-manifesto.md)) reinforces it.
...
**Why**: customers who feel respected stay. The compounding NRR target ([go-to-market §7.1](./STR-08-go-to-market.md)) depends on it.
...
- Brand-voice spot check (one piece of customer-facing copy reviewed against [manifesto §5](./STR-01-manifesto.md))
...
- Plugin developer conference (per [platform-strategy §10.2](./STR-10-platform-strategy.md))
...
| Doc | Relationship |
|---|---|
| [STR-01-manifesto.md](./STR-01-manifesto.md) | The brand voice + cultural foundation |
| [STR-07-positioning.md](./STR-07-positioning.md) | Why these principles serve the moat |
| [STR-03-engineering-vision.md](./STR-03-engineering-vision.md) | The P1–P8 architectural principles (code, not team) |
| [STR-08-go-to-market.md](./STR-08-go-to-market.md) | The GTM implementation of these principles |
| [STR-15-risks-and-assumptions.md](./STR-15-risks-and-assumptions.md) | Cultural / hiring risks |
