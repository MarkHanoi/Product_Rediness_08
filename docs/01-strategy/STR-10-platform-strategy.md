...
A developer evaluating "should I publish on PRYZM?" reads these five docs. The economics + the technical substrate + the AI plane + the command authoring + the batch catalogue are all transparent. We trade the secrecy moat for the momentum moat — see [positioning §4.1](./STR-07-positioning.md).
...
Cross-link to [STR-15-risks-and-assumptions.md](./STR-15-risks-and-assumptions.md) for full treatment. Briefly:
...
| Doc | Relationship |
|---|---|
| [STR-01-manifesto.md](./STR-01-manifesto.md) | The platform reflects the brand's openness + curation |
| [STR-07-positioning.md](./STR-07-positioning.md) | The platform is the structural moat |
| [STR-09-personas.md](./STR-09-personas.md) — esp C5 | The plugin developer archetype |
| [STR-08-go-to-market.md](./STR-08-go-to-market.md) | Developer relations as a GTM channel |
| [STR-12-site-and-cognition-strategy.md](./STR-12-site-and-cognition-strategy.md) | The substrate the platform extends |
