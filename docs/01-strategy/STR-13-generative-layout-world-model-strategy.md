...
> (the engine), the v3.0 spec (normative target), and [building-graph strategy](STR-14-pryzm-building-graph-and-relational-ai-foundation.md).
...
and recorded in [ADR-0062](../02-decisions/adrs/ADR-0062-layout-engine-deterministic-graph-solver.md). *(Competitor
