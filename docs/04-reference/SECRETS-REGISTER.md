...
| `VITE_GOOGLE_MAPS_KEY` | PUBLIC-TOKEN | build-time-inlined | required-in-prod-only | CI + deploy + editor-client | — | broken-bundle — photorealistic tiles unavailable. Baked into the public bundle BY DESIGN — restrict by API + referrer | .github/workflows/deploy-fly.yml:430 · apps/editor/src/ui/geospatial/CesiumViewport.ts:253 · Dockerfile:127 · Dockerfile:128 · tools/deploy/fly-manual-deploy.sh:166 |
