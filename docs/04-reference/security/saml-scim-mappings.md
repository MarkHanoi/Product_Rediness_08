...
**Spec ref**: `docs/archive/pryzm3-internal/reference/phases/PHASE-3/3D-Q4-M34-M36-HARDENING-GA.md` §S68 exit-criteria table row 8 — "SAML / SCIM mappings table per `[strategic ADR-0221]` + SPEC-24 §1.1".
**Strategic anchor**: `[strategic ADR-0221]` — Enterprise SSO model.
