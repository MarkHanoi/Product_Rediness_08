...
| L-55 | wall-audit | **Missing OTel P8 spans on wall command handlers / wall-committer** — verify the bus wrapper coverage or add spans; document the sound choice. | Observability/Walls | OPEN | queued (this agent) |
