...
> **Generated** 2026-08-11T20:58:55.707Z by `tools/rac-conformance/certification/generate-report.ts`
...
- **PARTIALLY VERIFIED** (best attainable — see the Collaboration note): **29**
- **FAILED** (a measured axis disproved the invariant): **5**
...
| `wall` | 2 | PROVEN — SEEDED | PROVEN — mutated through a LIVE bus verb before save | PROVEN — 2 record(s) present in the authoritative store before save (executed read-back) | UNPROVEN — no fragment builders run headlessly; meshes never built in this harn… | FAIL — 8 divergence(s): wall.cert-wall-1._renderVersion: expected 4 got 2 \| wall.cert-wall-1.metadata.createdAt: expected 1786481892193 got 1786481898424 \| wall.cert-wall-1.metadata.modifiedAt: expected 1786481892281 got 1786481898424 \| wall.cert-wall-1.metadata.version: expected 2 got 1 \| wall.cert-wall-2._renderVers… | n/a — H2 | UNPROVEN — no transport | PROVEN — loader returned a structured LoadResult (success=true, loaded=18, failed=0) | **FAILED** |
...
| `roof` | 1 | PROVEN — SEEDED | PROVEN — mutated through a LIVE bus verb before save | PROVEN — 1 record(s) present in the authoritative store before save (executed read-back) | UNPROVEN — no fragment builders run headlessly; meshes never built in this harn… | FAIL — 3 divergence(s): roof.cert-roof-1.metadata.createdAt: expected 1786481892209 got 1786481898443 \| roof.cert-roof-1.metadata.modifiedAt: expected 1786481892276 got 1786481898443 \| roof.cert-roof-1.metadata.version: expected 2 got 1 | n/a — H2 | UNPROVEN — no transport | PROVEN — loader returned a structured LoadResult (success=true, loaded=18, failed=0) | **FAILED** |
...
| `element.updateParameters` | set wall colour via the generic parameter path | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: wall.u-wall-1.materialColor, wall.u-wall-1.metadata.modifiedAt, wall.u-wall-1.metadata.version (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store; 1 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
...
| `ceiling.update` | set ceiling height | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: ceiling.u-ce-1.metadata.modifiedAt, ceiling.u-ce-1.metadata.version, ceiling.u-ce-1.height (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry; 1 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store; 1 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `door.setOffset` | move a door along its wall | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: wall.u-wall-1.openings.0.offset, wall.u-wall-1._renderVersion, door.8c4970aa-ab52-4421-817c-c4a7137e92d3.offset (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `window.setOffset` | move a window along its wall | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: wall.u-wall-2.openings.0.offset, wall.u-wall-2._renderVersion, window.1426173e-6929-4304-a49f-21f14703e915.offset (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `door.setSillHeight` | set door sill height (generic parameter bridge) | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: wall.u-wall-1.openings.0.sillHeight, wall.u-wall-1._renderVersion, door.8c4970aa-ab52-4421-817c-c4a7137e92d3.sillHeight (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `room.setMaterial (colour)` | set room fill colour | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: room.7e42d782-658c-4f8a-af87-07a450c78b7f.metadata.modifiedAt, room.7e42d782-658c-4f8a-af87-07a450c78b7f.metadata.version, room.7e42d782-658c-4f8a-af87-07a450c78b7f.colour (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store; 1 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `room.setName` | rename a room | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: room.7e42d782-658c-4f8a-af87-07a450c78b7f.name, room.7e42d782-658c-4f8a-af87-07a450c78b7f.metadata.modifiedAt, room.7e42d782-658c-4f8a-af87-07a450c78b7f.metadata.version (3 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store; 1 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `wall.updateSystemTypeBatch` | change ALL walls to a named type (batch = ONE undo) | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: wall.u-wall-1.thickness, wall.u-wall-1._renderVersion, wall.u-wall-1.metadata.modifiedAt, wall.u-wall-1.metadata.version, wall.u-wall-1.systemTypeId, wall.u-wall-1.layers … +6 (12 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store; 2 field(s) excluded — ADR-0319 class-3 (DERIVED-INCIDENTAL), enumerated by name: metadata.createdAt, metadata.modifiedAt) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `door.updateSystemTypeBatch` | change ALL doors to a named type (batch = ONE undo) | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: door.8c4970aa-ab52-4421-817c-c4a7137e92d3.frameThickness, door.8c4970aa-ab52-4421-817c-c4a7137e92d3.frameColor, door.8c4970aa-ab52-4421-817c-c4a7137e92d3.leafThickness, door.8c4970aa-ab52-4421-817c-c4a71… (8 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
| `window.updateSystemTypeBatch` | change ALL windows to a named type (batch = ONE undo) | PROVEN — resolved + dispatched on the real bus | 1 | PROVEN — authoritative state moved: window.1426173e-6929-4304-a49f-21f14703e915.glazingThickness, window.1426173e-6929-4304-a49f-21f14703e915.rebateDepth, window.1426173e-6929-4304-a49f-21f14703e915.frameFinish, window.1426173e-6929-4304-a… (6 paths moved) | UNPROVEN — no fragment builders headless; meshes never built | n/a — H1 | PROVEN — after undo, authoritative state ≡ State A (deep, whole-store, 1 entry) | PROVEN — after redo, authoritative state ≡ State B (deep, whole-store) | UNPROVEN — no transport exists (L-391 leg C) | PROVEN — dispatch resolved with a structured outcome (throw ≠ no-change, asserted separately) | **PARTIALLY VERIFIED** |
