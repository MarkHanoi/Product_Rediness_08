...
> **Authority**: this doc is the **per-folder + per-file reference** for the live repository tree. It is intentionally short — the per-package detail lives in [docs/01-strategy/STR-05-architecture-breakdown.md](../../01-strategy/STR-05-architecture-breakdown.md). The shape + lint matrix + composition root lives in [docs/01-strategy/STR-04-architecture.md](../../01-strategy/STR-04-architecture.md).
...
Layer assignments per [STR-04-architecture.md §1](../../01-strategy/STR-04-architecture.md). One-line purposes per [STR-05-architecture-breakdown.md §6](../../01-strategy/STR-05-architecture-breakdown.md).
...
47 total. Per-plugin one-liners in [STR-05-architecture-breakdown.md §7](../../01-strategy/STR-05-architecture-breakdown.md).
...
The repository structure **conforms to the layered model defined in [STR-04-architecture.md §1](../../01-strategy/STR-04-architecture.md)**. Specifically:
...
- A new package / plugin / app → add a row in [STR-05-architecture-breakdown.md](../../01-strategy/STR-05-architecture-breakdown.md) + update §5 counts here
- A renamed package / plugin / app → update both files in the same PR
- The boundary lint matrix or composition root changes → that updates [STR-04-architecture.md](../../01-strategy/STR-04-architecture.md), not this doc

Per [operating-principles O5](../../01-strategy/STR-06-operating-principles.md), drift is fixed by **editing this doc**, not by writing `*-AUDIT-YYYY-MM-DD.md` alongside it.
...
| Doc | Relationship |
|---|---|
| [docs/01-strategy/STR-04-architecture.md](../../01-strategy/STR-04-architecture.md) | Shape + boundary matrix + composition root + lint gates |
| [docs/01-strategy/STR-05-architecture-breakdown.md](../../01-strategy/STR-05-architecture-breakdown.md) | Per-package + per-plugin + per-app one-liner inventory |
| [docs/01-strategy/STR-03-engineering-vision.md](../../01-strategy/STR-03-engineering-vision.md) | P1–P8 principles + D1–D13 differentiators |
| [docs/01-strategy/STR-02-product-vision.md](../../01-strategy/STR-02-product-vision.md) | Product north star + user journey |
