# Niedersachsen — Land technical profile

**ISO 3166-2:** `de-ni` · **CRS:** ETRS89 / UTM 32N (EPSG:25832) ·
...
> formats for Niedersachsen have NOT been live-probed. Nothing here may move a RATE cell until
...
>
> **Note:** LGLN geoportal; DiPlanung operational 2026-07-23.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Niedersachsen's services implement them
...
2. Responsible authorities (per dataset) — LGLN (Landesamt für Geoinformation und Landesvermessung Niedersachsen) *(unprobed)*
