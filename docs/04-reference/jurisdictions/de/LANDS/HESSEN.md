# Hessen — Land technical profile

**ISO 3166-2:** `de-he` · **CRS:** ETRS89 / UTM 32N (EPSG:25832) ·
...
> formats for Hessen have NOT been live-probed. Nothing here may move a RATE cell until probed and
> wired. Empty and failed are the same value. NRW LoD2 is the only VERIFIED-LIVE anchor
> (`../LANDS/NORDRHEIN-WESTFALEN.md`).
>
> **Note:** HVBG / Geoportal Hessen.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Hessen's services implement them
...
2. Responsible authorities (per dataset) — HVBG / Geoportal Hessen *(unprobed)*
