# Sachsen — Land technical profile

**ISO 3166-2:** `de-sn` · **CRS:** ETRS89 / UTM 33N (EPSG:25833) ·
...
> formats for Sachsen have NOT been live-probed. Nothing here may move a RATE cell until probed and
> wired. Empty and failed are the same value. NRW LoD2 is the only VERIFIED-LIVE anchor
> (`../LANDS/NORDRHEIN-WESTFALEN.md`).
>
> **Note:** GeoSN / geoportal.sachsen.de.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Sachsen's services implement them
...
2. Responsible authorities (per dataset) — GeoSN (Staatsbetrieb Geobasisinformation und Vermessung Sachsen) *(unprobed)*
