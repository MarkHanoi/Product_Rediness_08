# Schleswig-Holstein — Land technical profile

**ISO 3166-2:** `de-sh` · **CRS:** ETRS89 / UTM 32N (EPSG:25832) ·
...
> formats for Schleswig-Holstein have NOT been live-probed. Nothing here may move a RATE cell until
> probed and wired. Empty and failed are the same value. NRW LoD2 is the only VERIFIED-LIVE anchor
> (`../LANDS/NORDRHEIN-WESTFALEN.md`).
>
> **Note:** gdi-sh.de; DiPlanung operational 2026-07-23.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Schleswig-Holstein's services implement
...
2. Responsible authorities (per dataset) — gdi-sh.de / LVermGeo SH *(unprobed)*
...
13. Hydrography (North Sea / Baltic coasts) — *unprobed*
14. Protected areas (BfN Natura2000 + Land landscape) — *unprobed*
15. Geology (BGR / state) — *unprobed*
16. Planning (BauGB → BauNVO → Bebauungsplan; DiPlanung operational 2026-07-23) — *unprobed*
