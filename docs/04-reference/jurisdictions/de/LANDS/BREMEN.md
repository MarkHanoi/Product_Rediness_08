# Bremen — Land technical profile

**ISO 3166-2:** `de-hb` · **Type:** city-state · **CRS:** ETRS89 / UTM 32N (EPSG:25832) ·
...
> formats for Bremen have NOT been live-probed. Nothing here may move a RATE cell until probed and
> wired. Empty and failed are the same value. NRW LoD2 is the only VERIFIED-LIVE anchor
> (`../LANDS/NORDRHEIN-WESTFALEN.md`).
>
> **Note:** city-state; Geoportal Bremen; DiPlanung operational 2026-07-23.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Bremen's services implement them
...
2. Responsible authorities (per dataset) — Geoportal Bremen / GeoInformation Bremen *(unprobed)*
