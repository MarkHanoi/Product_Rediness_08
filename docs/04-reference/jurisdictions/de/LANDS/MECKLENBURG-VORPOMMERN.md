# Mecklenburg-Vorpommern — Land technical profile

**ISO 3166-2:** `de-mv` · **CRS:** ETRS89 / UTM 33N (EPSG:25833) ·
...
> formats for Mecklenburg-Vorpommern have NOT been live-probed. Nothing here may move a RATE cell
> until probed and wired. Empty and failed are the same value. NRW LoD2 is the only VERIFIED-LIVE
> anchor (`../LANDS/NORDRHEIN-WESTFALEN.md`).
>
> **Note:** GAIA-MV / LAiV-MV.

Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Mecklenburg-Vorpommern's services
implement them independently. Populate each section from the Land geoportal on probe.
...
2. Responsible authorities (per dataset) — LAiV-MV / GAIA-MV *(unprobed)*
...
13. Hydrography (Baltic coast) — *unprobed*
