# Rheinland-Pfalz — Land technical profile

**ISO 3166-2:** `de-rp` · **CRS:** ETRS89 / UTM 32N (EPSG:25832) ·
...
> formats for Rheinland-Pfalz have NOT been live-probed. Nothing here may move a RATE cell until
...
Standards are national (AAA-Modell: AFIS / ALKIS / ATKIS); Rheinland-Pfalz's services implement
...
2. Responsible authorities (per dataset) — LVermGeo RP *(unprobed)*
...
13. Hydrography (Rhein / Mosel) — *unprobed*
