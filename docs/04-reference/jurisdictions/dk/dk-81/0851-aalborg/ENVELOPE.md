...
| **S4 — city STUDY default** | *karré* / perimeter band | ❌ none for 0851 (`dkPerimeterBlock` is Copenhagen-specific, L-619) |
...
coverage measurement exists** for Aalborg. DK publishes no structured setbacks/ground-coverage (byggelinjer are
