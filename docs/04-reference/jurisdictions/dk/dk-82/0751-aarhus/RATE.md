# City RATE — master completion scorecard — Aarhus (dk-82, 0751)
...
Aarhus (Region Midtjylland) is **nationally covered, not individually baked/packed** — it inherits Denmark's
