...
| **S4 — city STUDY default** | *karré* / perimeter band | ❌ none for 0461 (`dkPerimeterBlock` is Copenhagen-specific, L-619) |
...
coverage measurement exists** for Odense. DK publishes no structured setbacks/ground-coverage (byggelinjer are
