# City RATE — master completion scorecard — Odense (dk-83, 0461)
...
Odense (Region Syddanmark) is **nationally covered, not individually baked/packed** — it inherits Denmark's
