# Legislation Data-Readiness Rate — New York City (`us-ny-3651000`) city

<!-- MIGRATED 2026-07-30 (C63 L-649): this file WAS `RATE.md` (the legislation data-fill rate). Under the
     ratified naming convention the composite 7-axis master is now `RATE.md`; this legislation metric is
     `LEGISLATION-RATE.md`. Content unchanged except this note + the header. See ../../../_TEMPLATE/NAMING-CONVENTION.md. -->
...
*Last updated: 2026-07-24 (migrated to `LEGISLATION-RATE.md` 2026-07-30). Scaffold — no live probes run. The
`MaxAllwFAR` probe is the single highest-value next step for NYC. Maintainer: UNASSIGNED.*
