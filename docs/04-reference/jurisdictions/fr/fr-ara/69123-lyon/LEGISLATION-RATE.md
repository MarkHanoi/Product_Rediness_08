<!-- Renamed from RATE.md → LEGISLATION-RATE.md under the C63/L-649 naming convention (2026-07-30):
     this is the per-axis structured legislation/data-fill rate that FEEDS C63 Axis 2 (LEGISLATION);
     the 7-axis composite master is now the sibling RATE.md. Semantics UNCHANGED (C58/L-449 ruler). -->
# LEGISLATION-RATE — Lyon Métropole (`69123`) city — structured legislation/data-fill rate
