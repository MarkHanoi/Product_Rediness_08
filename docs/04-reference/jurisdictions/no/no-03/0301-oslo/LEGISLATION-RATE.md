# LEGISLATION-RATE — Oslo (0301)

> **Migration note (C63 §8.1 / L-649):** this is the legacy `RATE.md` structured-fill number, renamed to
> `LEGISLATION-RATE.md` this pass (its C58 / L-449 semantics are UNCHANGED — only the filename moved). The
> composite 7-axis master scorecard now lives at [`RATE.md`](./RATE.md); this file FEEDS its **LEGISLATION**
> axis (C63 §3 Axis 2). Naming: [`../../../_TEMPLATE/NAMING-CONVENTION.md`](../../../_TEMPLATE/NAMING-CONVENTION.md).
...
*Last updated: 2026-07-24 (content); migrated to `LEGISLATION-RATE.md` 2026-07-30 (C63 L-649). Planinnsyn viewer and grad av utnytting faktaark confirmed live. Standalone planregister WFS not yet confirmed. `BestemmelseUtnyttingsgrad` national stub confirmed. NDH and Matrikkelen parcel WFS confirmed live.*
