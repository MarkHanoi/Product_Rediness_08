# LEGISLATION-RATE — Zaragoza (INE 50297)
...
**No clau audit has been run for Zaragoza, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 50297 from the
