# LEGISLATION-RATE — Huesca (INE 22125)
...
**No clau audit has been run for Huesca, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 22125 from the
