# LEGISLATION-RATE — Santander (INE 39075)
...
**No clau audit has been run for Santander, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 39075 from the
