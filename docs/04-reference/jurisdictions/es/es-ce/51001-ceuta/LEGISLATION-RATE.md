# LEGISLATION-RATE — Ceuta (INE 51001)
...
**No clau audit has been run for Ceuta, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 51001 from the
