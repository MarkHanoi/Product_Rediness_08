# LEGISLATION-RATE — València (INE 46250)
...
**No clau audit has been run for València, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 46250 from the
