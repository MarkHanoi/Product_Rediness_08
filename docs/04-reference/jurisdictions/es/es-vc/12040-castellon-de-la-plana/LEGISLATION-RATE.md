# LEGISLATION-RATE — Castelló de la Plana (INE 12040)
...
**No clau audit has been run for Castelló de la Plana, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 12040 from the
