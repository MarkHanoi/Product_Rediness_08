# LEGISLATION-RATE — Cáceres (INE 10037)
...
**No clau audit has been run for Cáceres, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 10037 from the
