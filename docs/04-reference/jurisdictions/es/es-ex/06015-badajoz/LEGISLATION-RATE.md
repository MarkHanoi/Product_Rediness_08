# LEGISLATION-RATE — Badajoz (INE 06015)
...
**No clau audit has been run for Badajoz, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 06015 from the
