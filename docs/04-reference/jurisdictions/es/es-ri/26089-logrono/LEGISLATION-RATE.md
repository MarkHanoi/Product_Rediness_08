# LEGISLATION-RATE — Logroño (INE 26089)
...
**No clau audit has been run for Logroño, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 26089 from the
