# LEGISLATION-RATE — Lleida (INE 25120)
...
**No clau audit has been run for Lleida, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 25120 from the
