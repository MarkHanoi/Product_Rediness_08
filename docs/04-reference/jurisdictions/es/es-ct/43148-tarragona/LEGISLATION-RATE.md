# LEGISLATION-RATE — Tarragona (INE 43148)
...
**No clau audit has been run for Tarragona, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 43148 from the
