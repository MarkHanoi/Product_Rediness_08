...
| **S2 — router predicate** | per-city bbox in `providers/` | ❌ none for 43148 |
| **S3 — zone source** | Generalitat MUC (Catalonia-wide) — covers this city | ◻ source exists, not dispatch-wired |
