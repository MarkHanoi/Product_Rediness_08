# LEGISLATION-RATE — Girona (INE 17079)
...
**No clau audit has been run for Girona, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 17079 from the
