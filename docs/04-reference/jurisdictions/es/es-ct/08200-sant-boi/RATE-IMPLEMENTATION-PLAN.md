...
| **cert** | Sign `sources/VERIFICATION.md` (L-449 gate) → flip `SANT_BOI_ENVELOPE_VERIFIED` for the certified clau(s) only | moves the certified clau amber→green; re-derives the RATE.md number | **NOT STARTED** | UNASSIGNED |
