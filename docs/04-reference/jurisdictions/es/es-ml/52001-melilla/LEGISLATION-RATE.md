# LEGISLATION-RATE — Melilla (INE 52001)
...
**No clau audit has been run for Melilla, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 52001 from the
