# LEGISLATION-RATE — Pontevedra (INE 36038)
...
**No clau audit has been run for Pontevedra, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 36038 from the
