# LEGISLATION-RATE — A Coruña (INE 15030)
...
**No clau audit has been run for A Coruña, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 15030 from the
