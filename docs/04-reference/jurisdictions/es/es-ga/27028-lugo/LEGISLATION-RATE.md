# LEGISLATION-RATE — Lugo (INE 27028)
...
**No clau audit has been run for Lugo, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 27028 from the
