# LEGISLATION-RATE — Ourense (INE 32054)
...
**No clau audit has been run for Ourense, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 32054 from the
