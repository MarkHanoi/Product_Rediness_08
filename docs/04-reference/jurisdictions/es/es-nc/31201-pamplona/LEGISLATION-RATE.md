# LEGISLATION-RATE — Pamplona / Iruña (INE 31201)
...
**No clau audit has been run for Pamplona / Iruña, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 31201 from the
