# LEGISLATION-RATE — Almería (INE 04013)
...
**No clau audit has been run for Almería, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 04013 from the
