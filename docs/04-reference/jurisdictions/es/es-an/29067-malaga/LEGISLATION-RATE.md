# LEGISLATION-RATE — Málaga (INE 29067)
...
**No clau audit has been run for Málaga, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 29067 from the
