# LEGISLATION-RATE — Sevilla (INE 41091)
...
**No clau audit has been run for Sevilla, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 41091 from the
