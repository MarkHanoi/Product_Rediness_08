# LEGISLATION-RATE — Cádiz (INE 11012)
...
**No clau audit has been run for Cádiz, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 11012 from the
