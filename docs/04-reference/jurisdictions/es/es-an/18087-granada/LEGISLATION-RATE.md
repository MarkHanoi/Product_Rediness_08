# LEGISLATION-RATE — Granada (INE 18087)
...
**No clau audit has been run for Granada, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 18087 from the
