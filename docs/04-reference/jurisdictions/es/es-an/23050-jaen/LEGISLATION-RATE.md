# LEGISLATION-RATE — Jaén (INE 23050)
...
**No clau audit has been run for Jaén, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 23050 from the
