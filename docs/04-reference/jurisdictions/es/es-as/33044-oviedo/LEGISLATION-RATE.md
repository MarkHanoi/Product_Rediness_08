# LEGISLATION-RATE — Oviedo (INE 33044)
...
**No clau audit has been run for Oviedo, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 33044 from the
