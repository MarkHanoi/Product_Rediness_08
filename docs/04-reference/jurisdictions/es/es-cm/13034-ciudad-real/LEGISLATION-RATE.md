# LEGISLATION-RATE — Ciudad Real (INE 13034)
...
**No clau audit has been run for Ciudad Real, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 13034 from the
