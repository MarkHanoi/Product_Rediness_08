# LEGISLATION-RATE — Guadalajara (INE 19130)
...
**No clau audit has been run for Guadalajara, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 19130 from the
