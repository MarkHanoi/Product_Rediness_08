# LEGISLATION-RATE — Cuenca (INE 16078)
...
**No clau audit has been run for Cuenca, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 16078 from the
