# LEGISLATION-RATE — Palma (INE 07040)
...
**No clau audit has been run for Palma, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 07040 from the
