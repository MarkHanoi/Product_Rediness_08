# LEGISLATION-RATE — Valladolid (INE 47186)
...
**No clau audit has been run for Valladolid, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 47186 from the
