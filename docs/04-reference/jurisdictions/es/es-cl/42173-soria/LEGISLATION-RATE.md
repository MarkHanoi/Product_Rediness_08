# LEGISLATION-RATE — Soria (INE 42173)
...
**No clau audit has been run for Soria, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 42173 from the
