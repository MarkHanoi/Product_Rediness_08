# LEGISLATION-RATE — Burgos (INE 09059)
...
**No clau audit has been run for Burgos, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 09059 from the
