# LEGISLATION-RATE — Palencia (INE 34120)
...
**No clau audit has been run for Palencia, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 34120 from the
