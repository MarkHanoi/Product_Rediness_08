# LEGISLATION-RATE — León (INE 24089)
...
**No clau audit has been run for León, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 24089 from the
