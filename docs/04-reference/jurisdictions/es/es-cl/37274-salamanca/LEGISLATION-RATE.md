# LEGISLATION-RATE — Salamanca (INE 37274)
...
**No clau audit has been run for Salamanca, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 37274 from the
