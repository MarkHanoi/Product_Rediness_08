# LEGISLATION-RATE — Ávila (INE 05019)
...
**No clau audit has been run for Ávila, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 05019 from the
