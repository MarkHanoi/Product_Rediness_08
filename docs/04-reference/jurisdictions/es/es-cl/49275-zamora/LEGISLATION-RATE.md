# LEGISLATION-RATE — Zamora (INE 49275)
...
**No clau audit has been run for Zamora, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 49275 from the
