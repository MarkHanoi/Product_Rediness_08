# LEGISLATION-RATE — Vitoria-Gasteiz (INE 01059)
...
**No clau audit has been run for Vitoria-Gasteiz, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 01059 from the
