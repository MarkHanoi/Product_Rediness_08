# LEGISLATION-RATE — Bilbao (INE 48020)
...
**No clau audit has been run for Bilbao, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 48020 from the
