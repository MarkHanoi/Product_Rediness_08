# LEGISLATION-RATE — Donostia / San Sebastián (INE 20069)
...
**No clau audit has been run for Donostia / San Sebastián, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 20069 from the
