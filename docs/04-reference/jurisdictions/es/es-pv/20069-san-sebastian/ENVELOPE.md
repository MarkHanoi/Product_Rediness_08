# ENVELOPE — Donostia / San Sebastián (INE 20069)
...
|---|---|---|
| **S1 — parcel provider** | Catastro INSPIRE WFS (national) | ⚠ foral-blocked (Basque/Navarra own cadastre) |
| **S2 — router predicate** | per-city bbox in `providers/` | ❌ none for 20069 |
