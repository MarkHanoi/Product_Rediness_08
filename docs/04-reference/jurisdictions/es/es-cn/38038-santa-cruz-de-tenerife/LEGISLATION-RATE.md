# LEGISLATION-RATE — Santa Cruz de Tenerife (INE 38038)
...
**No clau audit has been run for Santa Cruz de Tenerife, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 38038 from the
