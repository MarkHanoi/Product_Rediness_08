# LEGISLATION-RATE — Las Palmas de Gran Canaria (INE 35016)
...
**No clau audit has been run for Las Palmas de Gran Canaria, and no rule pack is registered** (`rulepacks/registry.ts`
...
**What would move it:** enumerate the governing instrument + distinct zones for 35016 from the
