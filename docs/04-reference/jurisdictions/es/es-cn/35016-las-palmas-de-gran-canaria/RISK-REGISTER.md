# RISK-REGISTER — Las Palmas de Gran Canaria (INE 35016)
...
| R5 | Claiming baked context | this city is OUTSIDE the `spain` bake clip bbox → CONTEXT `outside-coverage`, not a fabricated presence. |
