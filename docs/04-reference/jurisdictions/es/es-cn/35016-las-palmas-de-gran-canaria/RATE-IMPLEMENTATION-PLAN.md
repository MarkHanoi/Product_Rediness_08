# RATE-IMPLEMENTATION-PLAN — Las Palmas de Gran Canaria (INE 35016)
...
| P2 | TERRAIN (10) | run `terrain.verify.mjs` round-trip for `laspalmas` → lift rung 50→100 | decoder pass |
...
| P4 | PARCEL (15) | run `computeParcelConfidence` over an N-parcel sample in the 35016 bbox | sample distribution |
| P5 | LEGISLATION (25) | source the governing instrument + zones → cite `sources/SOURCES.md` → sign `VERIFICATION.md` | L-449 |
| P6 | ENVELOPE (20) | author `es-35016-las-palmas-de-gran-canaria` rule pack once P5 lands | C58 certifiability |
