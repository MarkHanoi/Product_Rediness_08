...
| | |
|---|---|
| Handler files read | 1229 (floor 900) |
| **Verbs** | **320** (floor 250) |
| LIVE | 99 |
| REFUSES | 17 |
...
| `annotation.move` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.setColor` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.setKind` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.setRotation` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.setText` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.setTextHeight` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
| `annotation.update` | plugins/annotations | UNKNOWN | UNKNOWN | patch-pair → annotation | UNDECLARED | classified B |
...
| `beam.move` | plugins/beam | UNKNOWN | UNKNOWN | patch-pair → beam | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `beam.setMaterial` | plugins/beam | REFUSES | NONE | patch-pair → beam | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `beam.setSection` | plugins/beam | UNKNOWN | UNKNOWN | patch-pair → beam | UNDECLARED | classified B |
| `beam.setType` | plugins/beam | UNKNOWN | UNKNOWN | patch-pair → beam | UNDECLARED | classified B |
| `beam.update` | apps/editor | LIVE | beam | UNKNOWN (declares beam) | UNDECLARED | classified D |
...
| `ceiling.setBoundary` | plugins/ceiling | UNKNOWN | UNKNOWN | patch-pair → ceiling | UNDECLARED | classified B |
| `ceiling.setHeight` | plugins/ceiling | UNKNOWN | UNKNOWN | patch-pair → ceiling | UNDECLARED | classified D |
| `ceiling.setMaterial` | plugins/ceiling | REFUSES | NONE | patch-pair → ceiling | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `ceiling.update` | plugins/ceiling | SHADOWED | UNKNOWN | patch-pair → ceiling | synced via 'ceilingId' (disclose) | capability: set-height |
...
| `column.move` | plugins/column | UNKNOWN | UNKNOWN | patch-pair → column | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `column.setHeight` | plugins/column | UNKNOWN | UNKNOWN | patch-pair → column | UNDECLARED | classified D |
| `column.setMaterial` | plugins/column | REFUSES | NONE | patch-pair → column | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `column.setType` | plugins/column | UNKNOWN | UNKNOWN | patch-pair → column | UNDECLARED | classified B |
| `column.update` | apps/editor | LIVE | column | UNKNOWN (declares column) | UNDECLARED | classified D |
| `copy-selection` | plugins/selection | UNKNOWN | UNKNOWN | NONE (empty patch pair) | n/a (not a property verb) | classified B |
| `cube.move` | plugins/toy-cube | UNKNOWN | UNKNOWN | patch-pair → cube | UNDECLARED | UNDECLARED |
...
| `curtain-wall.addPanel` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
...
| `curtain-wall.move` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `curtain-wall.removePanel` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
...
| `curtain-wall.setGrid` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
| `curtain-wall.setMaterial` | plugins/curtain-wall | REFUSES | NONE | patch-pair → curtainwall | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `curtain-wall.setMullionType` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
| `curtain-wall.setOutline` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
| `curtain-wall.setPanelType` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
| `curtain-wall.setTransomType` | plugins/curtain-wall | UNKNOWN | UNKNOWN | patch-pair → curtainwall | UNDECLARED | classified B |
...
| `data.setDerivation` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified C |
...
| `dimension.move` | plugins/dimensions | UNKNOWN | UNKNOWN | patch-pair → dimension | UNDECLARED | classified B |
| `dimension.setPrecision` | plugins/dimensions | UNKNOWN | UNKNOWN | patch-pair → dimension | UNDECLARED | classified B |
| `dimension.setText` | plugins/dimensions | UNKNOWN | UNKNOWN | patch-pair → dimension | UNDECLARED | classified B |
| `dimension.setUnit` | plugins/dimensions | UNKNOWN | UNKNOWN | patch-pair → dimension | UNDECLARED | classified B |
...
| `door.move` | plugins/door | UNKNOWN | UNKNOWN | patch-pair → door | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `door.setAccessibility` | plugins/door | UNKNOWN | UNKNOWN | patch-pair → door | UNDECLARED | classified B |
| `door.setFireRating` | plugins/door | UNKNOWN | UNKNOWN | patch-pair → door | UNDECLARED | classified B |
| `door.setFrameColor` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `door.setHeight` | plugins/door | SHADOWED | UNKNOWN | patch-pair → door | UNDECLARED | classified D |
| `door.setOffset` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `door.setSillHeight` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified D |
| `door.setSwing` | plugins/door | UNKNOWN | UNKNOWN | patch-pair → door | UNDECLARED | classified B |
| `door.setType` | plugins/door | UNKNOWN | UNKNOWN | patch-pair → door | UNDECLARED | classified B |
| `door.setWidth` | plugins/door | SHADOWED | UNKNOWN | patch-pair → door | UNDECLARED | classified D |
...
| `elementType.update` | apps/editor | LIVE | legacy geometry store (via commandManager) | UNKNOWN | UNDECLARED | classified C |
...
| `floor.update` | apps/editor | LIVE | floor | UNKNOWN (declares floor) | UNDECLARED | classified D |
...
| `furniture.move` | plugins/furniture | UNKNOWN | UNKNOWN | patch-pair → furniture | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `furniture.rotate` | plugins/furniture | UNKNOWN | UNKNOWN | patch-pair → furniture | n/a (not a property verb) | deferred (CHAT_UNAVAILABLE) |
| `furniture.setActiveLod` | plugins/furniture | UNKNOWN | UNKNOWN | patch-pair → furniture | UNDECLARED | classified C |
| `furniture.setMaterial` | plugins/furniture | REFUSES | NONE | patch-pair → furniture | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `furniture.setRepresentation` | plugins/furniture | UNKNOWN | UNKNOWN | patch-pair → furniture | UNDECLARED | classified C |
| `furniture.setScale` | plugins/furniture | UNKNOWN | UNKNOWN | patch-pair → furniture | UNDECLARED | classified B |
...
| `grid.add` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified D |
...
| `grid.setExtent` | plugins/grid | UNKNOWN | UNKNOWN | patch-pair → grid | UNDECLARED | classified B |
| `grid.setSpacing` | plugins/grid | UNKNOWN | UNKNOWN | patch-pair → grid | UNDECLARED | classified B |
| `grid.update` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified D |
...
| `handrail.moveBaseLine` | apps/editor | LIVE | handrail | patch-pair → handrail | UNDECLARED | classified B |
| `handrail.recompute` | plugins/handrail | UNKNOWN | UNKNOWN | patch-pair → handrail | n/a (not a property verb) | classified C |
| `handrail.setHost` | plugins/handrail | UNKNOWN | UNKNOWN | patch-pair → handrail | UNDECLARED | classified B |
| `handrail.setMaterial` | plugins/handrail | REFUSES | NONE | patch-pair → handrail | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `handrail.setPath` | plugins/handrail | UNKNOWN | UNKNOWN | patch-pair → handrail | UNDECLARED | classified B |
| `handrail.setShape` | plugins/handrail | UNKNOWN | UNKNOWN | patch-pair → handrail | UNDECLARED | classified B |
| `handrail.updateColor` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `hierarchy.updateNode` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified C |
...
| `level.update` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified B |
...
| `lighting.move` | plugins/lighting | UNKNOWN | UNKNOWN | patch-pair → lighting | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `lighting.setEmergency` | plugins/lighting | UNKNOWN | UNKNOWN | patch-pair → lighting | UNDECLARED | classified B |
| `lighting.setIntensity` | plugins/lighting | UNKNOWN | UNKNOWN | patch-pair → lighting | UNDECLARED | classified D |
| `lighting.setMaterial` | plugins/lighting | REFUSES | NONE | patch-pair → lighting | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `plumbing.move` | plugins/plumbing | UNKNOWN | UNKNOWN | patch-pair → plumbing | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `plumbing.moveFixture` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `plumbing.setMaterial` | plugins/plumbing | REFUSES | NONE | patch-pair → plumbing | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `plumbing.setSystem` | plugins/plumbing | UNKNOWN | UNKNOWN | patch-pair → plumbing | UNDECLARED | classified B |
...
| `rhino.setMaterial` | apps/editor | LIVE | legacy geometry store (via commandManager) | UNKNOWN | UNDECLARED | capability: set-rhino-material |
| `roof.addSkylight` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified B |
...
| `roof.move` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `roof.removeSkylight` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified B |
| `roof.setMaterial` | plugins/roof | REFUSES | NONE | patch-pair → roof | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `roof.setOverhang` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified D |
| `roof.setPitch` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified D |
| `roof.setShape` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified B |
| `roof.setThickness` | plugins/roof | UNKNOWN | UNKNOWN | patch-pair → roof | UNDECLARED | classified D |
...
| `room.move` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `room.setFinish` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified B |
| `room.setHeightOffset` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | capability: set-room-height-offset |
| `room.setMaterial` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `room.setName` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified D |
| `room.setNumber` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | capability: set-room-number |
| `room.setOccupancy` | plugins/rooms | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified B |
| `room.updateBoundary` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified C |
...
| `schedule.setFilter` | plugins/schedules | UNKNOWN | UNKNOWN | NONE (empty patch pair) | UNDECLARED | classified B |
| `schedule.setGroupBy` | plugins/schedules | UNKNOWN | UNKNOWN | NONE (empty patch pair) | UNDECLARED | classified B |
| `schedule.update` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified D |
...
| `section.moveLine` | plugins/section-view | UNKNOWN | UNKNOWN | patch-pair → section | UNDECLARED | classified B |
| `section.setDepth` | plugins/section-view | UNKNOWN | UNKNOWN | patch-pair → section | UNDECLARED | classified B |
| `section.setMark` | plugins/section-view | UNKNOWN | UNKNOWN | patch-pair → section | UNDECLARED | classified B |
| `section.setScale` | plugins/section-view | UNKNOWN | UNKNOWN | patch-pair → section | UNDECLARED | classified B |
...
| `sheet.addViewport` | plugins/sheets | SHADOWED | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `sheet.addWidget` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
...
| `sheet.moveViewport` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified B |
| `sheet.removeViewport` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `sheet.removeWidget` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `sheet.rename` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified F |
| `sheet.reorder` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | n/a (not a property verb) | classified B |
| `sheet.setSheetMetadata` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `sheet.setTitleBlock` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `sheet.setViewportScale` | plugins/sheets | UNKNOWN | UNKNOWN | patch-pair → sheet | UNDECLARED | classified B |
| `slab.addHole` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | classified B |
...
| `slab.move` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `slab.movePolygon` | apps/editor | LIVE | slab | UNKNOWN (declares slab) | UNDECLARED | classified B |
| `slab.removeHole` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | classified B |
| `slab.setBaseOffset` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | classified D |
| `slab.setMaterial` | plugins/slab | REFUSES | NONE | patch-pair → slab | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `slab.setThickness` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | classified D |
| `slab.setType` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | UNDECLARED | classified B |
| `slab.update` | plugins/slab | UNKNOWN | UNKNOWN | patch-pair → slab | synced via 'id' (disclose) | classified D |
| `slab.updateDimensions` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | capability: set-thickness |
...
| `stair.move` | plugins/stair | SHADOWED | UNKNOWN | NONE (empty patch pair) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `stair.rotate` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | n/a (not a property verb) | deferred (CHAT_UNAVAILABLE) |
| `stair.setMaterial` | plugins/stair | REFUSES | NONE | patch-pair → stair | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `stair.setRiserHeight` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | UNDECLARED | classified D |
| `stair.setShape` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | UNDECLARED | classified B |
| `stair.setTreadCount` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | UNDECLARED | classified D |
| `stair.setType` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | UNDECLARED | classified B |
| `stair.setWidth` | plugins/stair | UNKNOWN | UNKNOWN | patch-pair → stair | UNDECLARED | classified D |
...
| `structural.move` | plugins/structural | UNKNOWN | UNKNOWN | patch-pair → structural | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `structural.setBraceEndOffset` | plugins/structural | UNKNOWN | UNKNOWN | patch-pair → structural | UNDECLARED | classified B |
| `structural.setDimensions` | plugins/structural | UNKNOWN | UNKNOWN | patch-pair → structural | UNDECLARED | classified F |
| `structural.setKind` | plugins/structural | UNKNOWN | UNKNOWN | patch-pair → structural | UNDECLARED | classified B |
| `structural.setMaterial` | plugins/structural | REFUSES | NONE | patch-pair → structural | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `vg.updateVisibilityIntent` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified C |
...
| `view.setGraphicOverride` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified B |
...
| `viewTemplate.update` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | classified C |
...
| `wall.move` | plugins/wall | UNKNOWN | UNKNOWN | UNKNOWN (declares wall) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `wall.setSystemType` | plugins/wall | UNKNOWN | UNKNOWN | patch-pair → wall | UNDECLARED | classified D |
| `wall.transform` | plugins/wall | UNKNOWN | UNKNOWN | patch-pair → wall | n/a (not a property verb) | deferred (CHAT_UNAVAILABLE) |
| `wall.updateBaseline` | plugins/wall | UNKNOWN | UNKNOWN | NONE (empty patch pair) | synced via 'wallId' (disclose) | classified B |
| `wall.updateColor` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `window.move` | plugins/window | UNKNOWN | UNKNOWN | patch-pair → window | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
...
| `window.setFireRating` | plugins/window | UNKNOWN | UNKNOWN | patch-pair → window | UNDECLARED | classified B |
| `window.setFrameColor` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `window.setOffset` | apps/editor | LIVE | legacy geometry store (via commandManager) | legacy-stack (no affectedStores) | UNDECLARED | deferred (CHAT_UNAVAILABLE) |
| `window.setSillHeight` | plugins/window | SHADOWED | UNKNOWN | patch-pair → window | UNDECLARED | classified D |
| `window.setSize` | plugins/window | SHADOWED | UNKNOWN | patch-pair → window | UNDECLARED | classified D |
| `window.setType` | plugins/window | UNKNOWN | UNKNOWN | patch-pair → window | UNDECLARED | classified B |
...
| verb | sites |
|---|---|
| `ceiling.update` | `plugins/ceiling/src/handlers/UpdateCeiling.ts` · `apps/editor/src/engine/initBusHandlers.ts` |
