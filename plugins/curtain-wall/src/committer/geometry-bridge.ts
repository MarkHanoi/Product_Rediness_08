// geometry-bridge — curtain-wall BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildCurtainWallBufferGeometry(d: BufferGeometryDescriptor): THREE.BufferGeometry {
...
export function disposeCurtainWallGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
