// geometry-bridge — lighting BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildLightingBufferGeometry(
...
export function disposeLightingGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
