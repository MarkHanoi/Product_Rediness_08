// geometry-bridge — column BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildColumnBufferGeometry(
...
export function disposeColumnGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
