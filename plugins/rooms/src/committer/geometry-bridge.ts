// geometry-bridge — room BufferGeometryDescriptor → THREE.BufferGeometry.
//
// Symmetrical analogue of `plugins/slab/src/committer/geometry-bridge.ts`.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildRoomBufferGeometry(
...
export function disposeRoomGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
