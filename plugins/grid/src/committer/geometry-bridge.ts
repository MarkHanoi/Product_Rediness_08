// geometry-bridge — grid BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildGridBufferGeometry(d: BufferGeometryDescriptor): THREE.BufferGeometry {
...
export function disposeGridGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
