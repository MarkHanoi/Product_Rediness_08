// @pryzm/plugin-export-pdf — contribution surface (F-prereq.1).
//
// Empty placeholder array; the F.5.x sub-phases of
// `PRYZM2-WIREUP-PLAN-S72` populate this list with the PDF export
// pipeline contributions (sheets → PDF, BCF → PDF, view-action menu
// items).  See also `PHASES-A-F-MISSING-ITEMS-2026-04-29.md` §II.F.0.1
// — the F-prereq.1 baseline that lets the per-family F.x sub-phases
// land race-free.
//
