// geometry-bridge — stair BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildStairBufferGeometry(
...
export function disposeStairGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
