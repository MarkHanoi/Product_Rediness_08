...
PRYZM 2 — empty floor plugin shell (F-prereq.0). Floor-plan / sheet generation primitives land in F.x; this scaffold reserves the workspace package + descriptor slot.
