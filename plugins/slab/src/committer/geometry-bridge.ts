// geometry-bridge — slab BufferGeometryDescriptor → THREE.BufferGeometry.
//
// Symmetrical analogue of `plugins/roof/src/committer/geometry-bridge.ts`.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildSlabBufferGeometry(
...
export function disposeSlabGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
