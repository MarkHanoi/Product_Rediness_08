// geometry-bridge — plumbing BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildPlumbingBufferGeometry(
...
export function disposePlumbingGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
