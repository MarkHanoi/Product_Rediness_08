// @pryzm/plugin-render — contribution surface (F-prereq.1).
//
// Empty placeholder array; the F.6.x sub-phases of
// `PRYZM2-WIREUP-PLAN-S72` populate this list with the render-pipeline
// contributions (post-FX pass registrations, lighting presets,
// SSGI / bloom toggle UI).  See also
