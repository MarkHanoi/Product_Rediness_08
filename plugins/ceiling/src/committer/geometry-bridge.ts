...
export function buildCeilingBufferGeometry(d: BufferGeometryDescriptor): THREE.BufferGeometry {
...
export function disposeCeilingGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
