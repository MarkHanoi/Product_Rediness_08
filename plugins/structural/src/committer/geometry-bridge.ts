// geometry-bridge — structural BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildStructuralBufferGeometry(
...
export function disposeStructuralGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
