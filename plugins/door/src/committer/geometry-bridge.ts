// geometry-bridge — door BufferGeometryDescriptor → THREE.BufferGeometry.
//
// Symmetrical analogue of `plugins/wall/src/committer/geometry-bridge.ts`.
// Pure translation; pooling is the committer's concern.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildDoorBufferGeometry(
...
export function disposeDoorGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
