// geometry-bridge — roof BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildRoofBufferGeometry(
...
export function disposeRoofGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
