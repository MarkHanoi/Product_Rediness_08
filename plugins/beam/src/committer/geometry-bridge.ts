// geometry-bridge — beam BufferGeometryDescriptor → THREE.BufferGeometry.

import * as THREE from '@pryzm/renderer-three/three';
import type { BufferGeometryDescriptor } from '@pryzm/plugin-sdk';

export function buildBeamBufferGeometry(d: BufferGeometryDescriptor): THREE.BufferGeometry {
...
export function disposeBeamGeometry(g: THREE.BufferGeometry | null | undefined): void {
  if (g) g.dispose();
}
