...
export const REGION_SOURCE = {
  ...
  germany: 'lod2de',   // ⭐ WIRED 2026-09-05 (lane HEIGHTS-DE-LAENDER, §DE-LOD2-LAENDER-OSM-JOIN): the bake `germany` row declares heightJoin:'lod2de' → NATIONAL_STAMP_TABLE → stampDeLod2LaenderHeightsOnGeojsonseq (heights/deLod2LaenderStamp.mjs; router table + working set DE_LOD2_CITY_BBOXES in heights/deLod2Laender.mjs). Eleven keyless Land doors WIRED (nw bb hh sh th rp mv be st ni bw — one city each: koln berlin hamburg potsdam kiel erfurt mainz schwerin magdeburg hannover stuttgart; NI via the S3-listed LGLN bucket, its geojson index's hrefs being stale → NoSuchKey; BW via an ODD-easting 2 km grid read off the portal's own 2x2Gitter MVT, kind zip-multi — its zip is a FOLDER of four 1 km quarters); sn/he BLOCKED, hb/sl UNPROBED (all four RE-PROBED 2026-09-05 and still refused by name), by probed OPEN (CC BY 4.0) but UNARMED — munich's `blocked` reason below is stale. Local proof potsdam 1,832/2,012 · hamburg 636/729 · berlin 376/424 · hannover 658/722 · stuttgart 28,734/35,180 over 12 tiles, 0 tile errors (footprints read from the LIVE published buildings.pmtiles). The koln city row (heightJoin:'lod2nrw') stays until the orchestrator folds it.
