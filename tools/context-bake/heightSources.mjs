...
export const REGION_SOURCE = {
  ...
  germany: 'lod2de',   // ⭐ WIRED 2026-09-05 (lane HEIGHTS-DE-LAENDER, §DE-LOD2-LAENDER-OSM-JOIN): the bake `germany` row declares heightJoin:'lod2de' → NATIONAL_STAMP_TABLE → stampDeLod2LaenderHeightsOnGeojsonseq (heights/deLod2LaenderStamp.mjs; router table + working set DE_LOD2_CITY_BBOXES in heights/deLod2Laender.mjs). Nine keyless Land doors WIRED (nw bb hh sh th rp mv be st — one city each: koln berlin hamburg potsdam kiel erfurt mainz schwerin magdeburg); ni/sn/he BLOCKED, bw/hb/sl UNPROBED, by probed OPEN (CC BY 4.0) but UNARMED — munich's `blocked` reason below is stale. Local proof potsdam 1,832/2,012 · hamburg 636/729 · berlin 376/424. The koln city row (heightJoin:'lod2nrw') stays until the orchestrator folds it.
