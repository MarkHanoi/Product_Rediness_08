...
const GATES: Gate[] = [
  ...
  // "there is nothing here" and "this was never wired" the same value (C78 §1.4).
  //
  // STATIC, so it belongs in THIS runner and not certify, by the §2.1a boundary test —
  // it needs nothing that does not exist until something runs. Its executed siblings are
