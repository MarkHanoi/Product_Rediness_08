...
export function computeTakeoff(stores: TakeoffStores = defaultTakeoffStores()): TakeoffResult {
  ...
  coverage.push(
    ...
    { family: 'Insulation & membranes',  state: 'NOT_MEASURED', note: 'Wall/floor system-type LAYERS are modelled but are not yet broken out into per-layer m² lines. This is the single largest buildable gap — see ADR-0343 §4.' },
