...
export class IsolateElementInViewCommand implements Command {
    ...
    execute(_ctx: CommandContext): CommandResult {
        ...
        visibilityOverrides.push({ targetKind: 'element', targetId: this.elementId, action: 'isolate' });
        applyOverrideLayer(this.viewId, { ...current, visibilityOverrides, isolateActive: true });
