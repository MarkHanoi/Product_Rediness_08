...
export {
    ...
    FR_GPU_MODULES,
    FR_GPU_POINT_MODULES,
    FR_GPU_USER_AGENT,
    FR_GPU_WFS_FALLBACK_BASE,
    FR_GPU_WFS_LAYERS,
    FR_DOC_URBA_WFS_LAYER,
    buildFrGpuPointUrl,
    buildFrGpuWfsPointUrl,
    frGpuGetJson,
    frGpuFeaturesAtPoint,
    frWfsFeaturesAtPoint,
...
// LANE FR-STEP4 — the no-extraction product (brief §11 step 4) and its sources.
export {
    FR_ALTIMETRY_ENDPOINT,
    FR_ALTIMETRY_RESOURCE,
    FR_ALTIMETRY_NODATA_SENTINEL,
    buildFrAltimetryUrl,
    frElevationAtPoint,
    type FrElevation,
} from './frAltimetry.js';
export {
    FR_BDTOPO_WFS_ENDPOINT,
    FR_BDTOPO_LAYER,
    FR_BDTOPO_HONESTY_CAVEAT,
    FR_NEIGHBOUR_RADIUS_DEG,
    FR_NEIGHBOUR_COUNT_CAP,
    buildFrBdTopoBboxUrl,
    frNeighbourBuildingsAtPoint,
    type FrNeighbourBuilding,
    type FrNeighbourBuildings,
} from './frBdTopoNeighbours.js';
export {
    FR_EXTRACT_MIRROR_DECISION,
    frApiCartoExtractSource,
    type FrExtractSourceImplementation,
    type FrExtractSourcePort,
} from './frExtractMirrorPort.js';
export {
    FR_DOC_URBA_SELECTION_RULE,
    FR_DOCUMENT_SELECTION_RULE,
    FR_GPU_AUTHORITY,
    FR_GEOPLATEFORME_AUTHORITY,
    FR_GPU_DOWNLOAD_BY_PARTITION_BASE,
    FR_GPU_SCOPE_NOTE,
    FR_LEGIFRANCE_CODE_URBANISME_URL,
    FR_MUNICIPALITY_SELECTION_RULE,
    FR_PRESCRIPTION_MEANINGS,
    FR_REGIME_ARTICLES,
    ...
    frYyyymmddToIso,
    normaliseFrDuType,
    parseFrDocUrbaFeature,
    parseFrDocumentFeature,
    parseFrPrescription,
    parseFrSupAssiette,
    pickFrDocUrbaRow,
    pickFrDocument,
    pickFrMunicipality,
    type FrDerivability,
    type FrDerivabilityClass,
    type FrDocUrbaRow,
    type FrDocumentAtPoint,
    type FrGoverningDocument,
    type FrNoExtractionFetches,
    type FrNoExtractionRecord,
    type FrPermittedUses,
    type FrPrescription,
    type FrPrescriptionMeaning,
    type FrPrescriptionsSlice,
    type FrRegime,
    type FrRegimeKind,
    type FrSlice,
    type FrSliceProvenance,
    type FrSupAssiette,
    type FrSupSlice,
    type FrTerrainSlice,
    type FrZoneSlice,
