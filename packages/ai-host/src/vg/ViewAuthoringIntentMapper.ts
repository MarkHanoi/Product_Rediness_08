...
import { CreateViewDefinitionCommand } from '@pryzm/command-registry';
import { UpdateViewDefinitionCommand } from '@pryzm/command-registry';
import { CreateVisibilityRuleCommand } from '@pryzm/command-registry';
import { UpdateVisibilityRuleCommand } from '@pryzm/command-registry';
import { DeleteVisibilityRuleCommand } from '@pryzm/command-registry';
import { TagElementCommand } from '@pryzm/command-registry';
import { CreateSheetCommand } from '@pryzm/command-registry';
import { UpdateSheetCommand } from '@pryzm/command-registry';
import { CreateScheduleCommand } from '@pryzm/command-registry';
import { UpdateScheduleCommand } from '@pryzm/command-registry';
import { viewDefinitionStore } from '@pryzm/core-app-model';
import { sheetStore } from '@pryzm/core-app-model';
import { scheduleStore } from '@pryzm/core-app-model/views';
    ...
    switch (intent.intentType) {
        ...
        case AIIntentType.CREATE_VIEW_DEFINITION: {
            ...
            return new CreateViewDefinitionCommand({
                ...
                name:        i.name,
                viewType:    i.viewType,
                ...(i.discipline    !== undefined ? { discipline:   i.discipline }                      : {}),
                ...(i.levelId                     ? { spatial:      { levelId: i.levelId } }            : {}),
                ...(i.phaseFilter                 ? { temporal:     { phaseFilter: i.phaseFilter } }    : {}),
                ...(i.vgTemplateId  !== undefined ? { vgTemplateId: i.vgTemplateId }                   : {}),
        ...
        case AIIntentType.UPDATE_VISIBILITY_RULE: {
            ...
            return new UpdateVisibilityRuleCommand(i.ruleId, {
                ...(i.patch.label     !== undefined ? { label:     i.patch.label }                              : {}),
                ...(i.patch.condition !== undefined ? { condition: i.patch.condition as QueryExpression }       : {}),
                ...(i.patch.effect    !== undefined ? { effect:    i.patch.effect }                             : {}),
                ...(i.patch.priority  !== undefined ? { priority:  i.patch.priority }                           : {}),
                ...(i.patch.enabled   !== undefined ? { enabled:   i.patch.enabled }                            : {}),
            });
        }
        ...
        case AIIntentType.CREATE_SHEET: {
            ...
            return new CreateSheetCommand({
                ...
                name:        si.name,
                ...(si.revision   !== undefined ? { revision:   si.revision }   : {}),
                ...(si.viewIds    !== undefined ? { viewIds:    si.viewIds }    : {}),
                ...(si.titleBlock !== undefined ? { titleBlock: si.titleBlock } : {}),
                createdBy:   'ai',
            });
        }
        ...
        case AIIntentType.CREATE_SCHEDULE: {
            ...
            return new CreateScheduleCommand({
                ...
                ...(ci.fields !== undefined ? { fields: ci.fields } : {}),
            });
        }
